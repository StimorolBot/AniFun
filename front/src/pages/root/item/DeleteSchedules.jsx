...
export const DeleteSchedules = memo(() => {
    ...
    const [request, isLoading, error] = useFetch(
        async (e) => {
            ...
            await api.delete("/admin/anime/delete-schedules", {data: payload})
    ...
    return(
        <li className="ra__item">
            <div className="ra__wrapper ra__wrapper_delete">
                <HeaderRouteRa method="delete" title="Удалить расписание" isActive={isActive} setIsActive={setIsActive}/>
                ...
                >
                    ...
                    {isLoading
                        ? <Loader/>
                        : <button className="ra__btn">Удалить расписание</button>
                    }
                </form>
            </div>
        </li>
