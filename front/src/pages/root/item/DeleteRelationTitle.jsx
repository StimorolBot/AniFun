...
export const DeleteRelationTitle = memo(() => {
    ...
    const [request, isLoading, error] = useFetch(
        async (e) => {
            ...
            await api.delete("/admin/anime/delete-relation-title", {data: payload})
    ...
    return(
        <li className="ra__item">
            <div className="ra__wrapper ra__wrapper_delete">
                <HeaderRouteRa method="delete" title="Разорвать связь между аниме" isActive={isActive} setIsActive={setIsActive}/>
                ...
                >
                    <table className="ra__table">
                        ...
                        <tbody className="ra__tbody">
                            ...
                            <RaTrInput 
                                ...
                                maxLength={150}
                                title={"Продолжение"} 
                                placeholder="Введите продолжение аниме"
                                payload={payload}
                                field={"title"}
                                setPayload={setPayload}
                            />
                    ...
                    {isLoading
                        ? <Loader/>
                        : <button className="ra__btn">Разорвать связь</button>
                    }
                </form>
            </div>
        </li>
