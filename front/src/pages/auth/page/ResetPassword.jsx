...
// import { AlertResponse } from "../../../ui/alert/AlertAPI"
...
export function ResetPassword() {
	...
	const { resetPassword, refetch, isLoading, error } = useQuery({
		...
		queryFn: async () => {
			await api.patch("/auth/reset-password", {
				...(location.state?.recaptcha_token || ""),
				...data.current,
			})
	...
	return (
		<>
			...
			<main className="auth">
				<AuthBg />
				<h1 className="title-page">Сброс пароля</h1>
					...
					<SwitchTransition mode="out-in">
						...
						>
							{isLoading ? (
								...
								<div
									className="auth__inner transition-loader"
									ref={transitionRef}
								>
									<AuthTitle
										title={"Новый пароль"}
										desc={
											<>
												Вы можете создать новый пароль
												для Вашей учетной записи
												<br />
												Проверьте Вашу почту и найдите
