...
export const RatingItem = memo(({myRating, starsList, mutation}) => {
            ...
            return(
                <Fragment key={index}>
                    <input 
                        ...
                        name="rating"
                        value={index}
                        onClick={e => mutation.mutate(Number(e.target.value))}
                    />
                    <label
                        ...
                        title={index}
                    >
                        <svg className="rating-star__svg" width="100%" height="100%" viewBox="0 0 24 24">
